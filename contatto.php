...
<head>
    ...
    <meta property="og:title" content="Contatto - Dental Concept 23">
    ...
    <title>Contatto - Dental Concept 23</title>
</head>
<body>
    ...
    <div class="container text-center">
        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            ...
            <button type="button" class="btn btn-7 active" onclick="window.location='contatto.php'"><a href="contatto">CONTATTO</a></button>
        </div>
        <div class="mt-lg-5">
    ...
    <br>
    <br>
    <div class="container mt-5 mt-md-5 mt-lg-5">
        <div class="row">
            <div class="col-lg-6 col-md-12 form-area">
                <?php echo $msg; ?> 
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <p>La procedura viene effettuata in due step.
                <br>
                Per i nuovi pazienti è previsto un soggiorno di 5 giorni; ulteriori soggiorni prevedono una durata di 7 giorni.
                </p>
                <p>Ai pazienti viene emessa regolare fattura valida per richiedere il rimborso sanitario nel proprio paese.</p>
                <p>La clinica emette anche un Passaporto Implantare e una garanzia di 10 anni sugli impianti. Tutti i pazienti sono assicurati e informati sulla qualità dei materiali.</p>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 mt-5 mt-md-5 mt-lg-5">
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-map-marker-alt fa-2x"></span> <em>Indirizzo: Stevana Sremca 13, Belgrado, Serbia</em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-phone fa-2x"></span> <em>Telefono: <a href="tel: +381644679448">+381/64-467-94-48</a> Interprete</em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-phone fa-2x"></span> <em>Telefono: <a href="tel: +39801852568">+39/801-85-25-68</a></em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-phone fa-2x"></span> <em>Telefono: <a href="tel: +393925876159">+39/392-58-761-59</a></em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-phone fa-2x"></span> <em>Telefono: <a href="tel: +33649763597">+33/649-76-35-97</a></em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-envelope fa-2x"></span> <em>E-mail: <a href="mailto: office@dentalconcept23.com">office@dentalconcept23.com</a> </em></p>
                <p class="contact" style="border: 3px solid #99CC00; border-radius: 5px; padding: 10px;"><span class="fas fa-envelope fa-2x"></span> <em>E-mail: <a href="mailto: dentalconcept23@gmail.com">dentalconcept23@gmail.com</a> </em></p>
            </div>
            <div class="col-lg-6 col-md-12 mt-5 mt-md-5 mt-lg-5">
                <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2830.363300207966!2d20.46901621521068!3d44.81416287909873!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a7abafb35b2dd%3A0x4b762665eda5c2e1!2sStevana+Sremca+13%2C+Beograd!5e0!3m2!1sen!2srs!4v1509400574031" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
